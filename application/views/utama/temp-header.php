...
<body class="animsition">
			...
			<div class="container h-full">
				<div class="wrap_header trans-0-3">
					...
					<div class="social flex-w flex-l-m p-r-20">
						...
						<?php if(isset($_SESSION['member_customer_012'])) {?>
						<a href="https://wa.me/<?= $ten->no_telp ?>" target="_blank"><i class="fa fa-user m-l-21" aria-hidden="true"></i></a>
						<?php }?>
	...
	<aside class="sidebar trans-0-4">
		...
		<ul class="menu-sidebar p-t-95 p-b-70">
			...
			<?php if(isset($_SESSION['member_customer_012'])) {?>
			<li class="t-center">
				<a href="<?= site_url('home/logout') ?>" class=" btn-success flex-c-m size13 txt11 trans-0-4 mt-2 m-l-r-auto">
					Log Out
				</a>
			</li>
			<?php }?>
