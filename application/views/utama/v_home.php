                ...
                <?php foreach($paket->result() as $key){ ?>
                    <div class="col-md-4">
                        <div class="pricing__item animated animatedFadeInUp fadeInUp">
                            ...
                            <ul>Tersedia <?= $key->stock ?> Paket* </br> Untuk Booking Di Tanggal Yang Sama </ul>
                            <a href="#booking" class="primary-btn mt-2">Book now</a>
                        </div>
                    </div>
                <?php } ?>
                ...
                <div class="col-lg-8">
                    <div class="request__form animated animatedFadeInLeft fadeInLeft">
                        <div class="section-title">
                            <span>Daftar</span>
                            <h2>Untuk Booking.!</h2>
                            <p>Lakukan Daftar User Untuk Melanjutkan Booking..</p>
                        </div>
                        <form class="wrap-form-reservation size22 m-l-r-auto" action="<?= site_url('home/daftar') ?>" method="POST" enctype= "multipart/form-data">
                            <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        ...
                                        <div class="size12 bo-rad-5 m-t-3 m-b-23">
                                            <input class="bo-rad-5 sizefull txt10 p-l-20" type="email" name="email" placeholder="Masukkan Email Anda" required />
                                        </div>
                                        <span class="txt9">Password</span>
                                        <div class="size12 bo-rad-5 m-t-3 m-b-23">
                                            <input class="bo-rad-5 sizefull txt10 p-l-20" type="text" name="password" placeholder="Buat Password" maxlength="8" onkeypress='return check_int(event)' required />
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="wrap-btn-booking flex-c-m mt-2">
                            <a class="btn3 flex-c-m sizefull p-3 txt11 trans-0-4" href="<?= site_url('home/v_login#login') ?>">
                                    Login! </a> 
                            </div>
                        </form>
                    </div>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <div class="request__form animated animatedFadeInLeft fadeInLeft">
                        ...
                        <form class="wrap-form-reservation size22 m-l-r-auto" action="<?= site_url('home/proses?id=').$user[0]->id; ?>" method="POST" enctype= "multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <span class="txt9">Nama</span>
                                    <div class="size12 bo-rad-5 m-t-3 m-b-23">
                                        <input class="bo-rad-5 sizefull txt10 p-l-20" type="text" name="nama" value="<?= $user[0]->nama;?>" required />
                                    </div>
                                    <span class="txt9">Email</span>
                                    <div class="size12 bo-rad-5 m-t-3 m-b-23">
                                        <input class="bo-rad-5 sizefull txt10 p-l-20" type="email" name="email" value="<?= $user[0]->email;?>" required />
                                    </div>
                            ...
                            <table id="bootstrap-data-table-export" class="table table-responsive table-hover table-xs nowrap" width="100%">
                                <thead>
                                    <tr><th width="1%">No</th>
                                        ...
                                        <?php if($this->session->userdata('member_customer_012')) { ?>
                                            <td>Bayar DP</td>
                                            <td>Total</td>
                                            <td>Status</td>
                                        <?php }?>
