                    ...
                    <div class="modal-body">
                        <div class="row">
	                        ...
	                        <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label >Stock Paket</label>
                                    <input type="number" class="form-control" placeholder="Stock Paket" name="stock_pkt" maxlength="2" onkeypress='return check_int(event)' required/>
                                    <span class="help-block"></span>
                                </div>
	                        </div>
		                </div>
